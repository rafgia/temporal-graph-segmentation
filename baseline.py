...
if __name__ == '__main__':
  start = datetime.now()
  nodes,node2id,timestamps,timestamp2id,edges,edge2id,timestamp2edges,snapshots,temporal_edges, new_temporal_dict = load_graph("C:/Users/Utente/Desktop/Temporal-SIR-GN-main/Experiments_with_datasets/aves-sparrow-social.csv", True,',')
  ...
  sum_penalties = 0
  for i in range(0,len(piecewise)): #penalties
